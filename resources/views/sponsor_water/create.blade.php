        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>新增赞助 <small> <span class="text-danger">[*]</span>为必填项</small></h5>
                </div>
                @include('errors.error')
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" action="{{ route('sponsor_water.store') }}">
                        @csrf

                        <div class="form-group {{ $errors->has('nickname') ? 'has-error' : '' }}">
                            <label class="col-sm-2 control-label"> 昵称<small class="text-danger">[*]</small></label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="nickname" placeholder="昵称" value="{{ old('nickname') }}" maxlength="255">
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="amount" placeholder="金额单位分" value="{{ old('amount') }}" maxlength="10">
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('sponsor_date') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control datepicker" name="sponsor_date" placeholder="赞助日期" data-provide="datepicker" value="{{ old('sponsor_date') }}" >
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('remark') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-4"><textarea name="remark" rows="5"  class="form-control "> {{ old('remark') }}</textarea></div>
