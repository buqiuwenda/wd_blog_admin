        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>新增类别 <small> <span class="text-danger">[*]</span>为必填项</small></h5>
                </div>
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" action="{{ route('category.store') }}">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="name" placeholder="类别名称，如：PHP" value="{{ old('name') }}" maxlength="128">
                            </div>
                            ...
                            <div class="col-sm-4">
                                <select name="parent_id" class="form-control m-b">
                                    ...
                                    @foreach($parents as $key=>$parent)
                                        <option @if(old('parent_id') == $key) selected @endif value="{{ $key }}">{{ $parent }}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="description" placeholder="描述" value="{{ old('description') }}" maxlength="255">
                            </div>
