                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-3 m-b-xs">
                            <a href="{{ route('member.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> 新增用户</a>
                        </div>
                            ...
                            <form action="{{ route('member.index') }}" method="get">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="text" placeholder="用户名称|邮箱|昵称" class="input-sm form-control" name="name" value="{{ request('name') }}">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($rows as $row)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                                            <a class="btn-white btn btn-xs" href="{{ route('member.show', $row) }}"><i class="fa fa-eye"></i> 查看</a>
                                            <a class="btn-white btn btn-xs" href="{{ route('member.edit', $row) }}"><i class="fa fa-edit"></i> 编辑</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
