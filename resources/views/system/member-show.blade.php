                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <p class="form-control-static">@if(!empty($row->roles->name)) {{ $row->roles->name }} @else 暂无 @endif</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-primary" href="{{ route('member.edit', $row) }}"><i class="fa fa-edit"></i> 编辑</a>
                            </div>
                        </div>
